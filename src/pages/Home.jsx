    ...
    <div className="page-wrap home-board">
      ...
      <p className="fine">
        {house == null
          ...
          : `House cap shown is ${season === 2026 ? '2026–27 ($21.6M, reported)' : '2025–26 ($20.5M, reported)'}. Capacity is the FY2025 filing stack, still labeled FY2025 — not a ${season === 2026 ? '2026' : '2025'} filing. Booked NIL on this list is the House Year 1 / 2025–26 filing when 2026–27 has not been extracted; those cells carry a year label. Leftover is House remaining only when a booked House spent cell exists — we do not invent leftover from a $20.5M cap plan. Capacity default is booked-only. Flip on + alumni model to add the Scorecard-based extra-alumni midpoint, net of booked gifts.`}
        {' '}FB pay, buyouts, conference exit, guarantee games, and wins-per-dollar live on the school page and on /buyout, /coach-fa, /guarantee-games, /tape, and the school #conference-exit / #debt drills — not on this first-screen rank.
        {' '}Compare <Link to="/reported-nil">reported NIL by school</Link> for every Power 4 football roster stack — gold bars, not leftover.
        {' '}Click a school.
      </p>
      </>
      )}

...
export const DEFS = {
  ...
  conferenceExit: {
    ...
    text: 'What a school would pay the conference to leave — a stock, not yearly spend, and not a coach-firing buyout. Three published instruments, plus one modeled reporter estimate. ACC: settlement year ladder (FY 2025–26 / 2026 exit $165M, then −$18M a year to a $75M floor through 2036); paying the fee lets the school leave with media rights. SEC: 2023–24 bylaws §3.2.1 $30 million with-notice withdrawal fee — cash, not a rights buyback; $40M / $45M stairs are footnoted. Big 12: hosted bylaws §3.4 cash formula (sum of distributions for the final two years of membership), modeled as 2 × the last cited FY2025 Form 990 Schedule I line — labeled modeled, never booked; paying the fee does not buy back media rights (the grant of rights still sits with the league). Notre Dame: modeled ~$100 million Hale / 247Sports estimate of the non-football ACC membership exit — not the FSU/Clemson football ladder. Empty means no hosted schedule (Big Ten). Not part of annual capacity. Booked-only remains the default capacity toggle.',
  },
  tape: {
    label: 'Desk tape',
